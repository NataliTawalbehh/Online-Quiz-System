...
export default class NotifyUtil {
  public static notify(options: QNotifyCreateOptions) {
    Notify.create({
      ...
      position: 'top',
      message:
        options && options.message ? options.message : StringUtil.translate(''),
